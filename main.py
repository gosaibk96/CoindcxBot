...
TRADE_PAIR = "B-XAU_USDT" # Verified active instrument from logs
TRADE_SIZE = 1000          # Size in INR / Currency
TRADE_LEVERAGE = 10       # Leverage (e.g., 10x)
TRADE_SIDE = "buy"        # "buy" (Long) or "sell" (Short)
# =====================================================================
